...
const MedicalHistoriesPageContent = () => {
  ...
  // Fetch patients and doctors data for name mapping
          ...
          <div className="flex min-h-[400px] items-center justify-center">
            <div className="rounded-2xl border border-red-100 bg-white p-8 text-center shadow-lg">
              ...
              <p className="text-gray-600">
                Something went wrong while fetching medical histories.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-6xl px-6 py-8">
            ...
            <div className="flex items-center gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                ...
                <span>{histories.length} records available</span>
              </div>
              <div className="flex items-center gap-2">
                <Clock className="size-4 text-blue-500" />
                <span>Real-time medical tracking</span>
              </div>
            </div>

            {/* Status Filter - moved inside header */}
          ...
          {filteredHistories.length === 0 ? (
            <div className="py-16 text-center">
              <div className="mx-auto max-w-md rounded-2xl bg-white p-12 shadow-lg">
                <FileText className="mx-auto mb-6 size-16 text-gray-400" />
                ...
                <p className="mb-6 text-gray-600">
                  {statusFilter === "all"
                    ? "Medical histories will appear here when available."
                    : `${statusFilter} medical histories will appear here when available.`}
                </p>
                {statusFilter === "all" && (
                  <button
                    onClick={handleCreateRecord}
                  ...
                  >
                    ...
                    <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
                      ...
                      <div className="rounded-lg bg-purple-50 p-4">
                        ...
                        <p className="text-lg font-semibold text-purple-900">
                          {getDoctorName(history.doctorId)}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 border-t border-slate-200 pt-4">
                      <div className="flex gap-3">
                        <button
                          onClick={() =>
                            handleViewRecord(history.medicalHistoryId)
                          }
                        ...
                        <button
                          onClick={() =>
                            handleEditRecord(history.medicalHistoryId)
                          }
...
const MedicalHistoriesPageClient = () => {
  return <MedicalHistoriesPageContent />;
};

export default MedicalHistoriesPageClient;
