...
import { LaboratoryTestReportQueryParam, LaboratoryTestReportResult, CreateLaboratoryTestReportRequest, UpdateLaboratoryTestReportRequest } from "@/types/laboratoryTestReport";
...
export const getAllMedicalHistory = async (
    params: LaboratoryTestReportQueryParam = { PageSize: 0, PageNumber: 1, Result: null }
...
): Promise<{ success: boolean; data?: LaboratoryTestReportResult; error?: string }> => {
    try {
