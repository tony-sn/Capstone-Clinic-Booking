...
const benefits = [
  {
    ...
    description:
      "State-of-the-art lab tests analyze key biomarkers to give you a full picture of your health.",
  },
  {
    icon: <Leaf className="size-6 text-theme-600" />,
    title: "Personalized Treatment Plans",
    description:
      "Our physicians review your results and craft targeted care strategies that fit your unique profile.",
  },
  {
    icon: <Zap className="size-6 text-theme-600" />,
    title: "Early Disease Detection",
    description:
      "Routine blood work uncovers potential issues before symptoms appear, so you can take action sooner.",
  },
  {
    icon: <Activity className="size-6 text-theme-600" />,
    title: "Holistic Wellness Monitoring",
    description:
      "Track your health trends over time and adjust lifestyle or medical recommendations for optimal well-being.",
  },
  {
    icon: <RefreshCw className="size-6 text-theme-600" />,
    title: "Detoxification & Nutrient Balancing",
    description:
      "Lab-guided insights help clear toxins and optimize nutrient levels to support cellular repair.",
  },
  {
    icon: <Droplets className="size-6 text-theme-600" />,
    title: "Enhanced Vitality",
    description:
      "With precise diagnostics and expert care, many patients report sustained energy boosts and improved resilience.",
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Our warranty of most advanced technologies and best practitioners in
            the world
          </p>
        </div>
