...
const MedicalHistoryDetailModal = ({
    ...
    const { data: apiResponse, isLoading: loading, error } = medicalDetail({ medicalHistoryId });
                ...
                {loading ? (
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                        <div className="flex items-center">
                            ...
                            <p className="text-red-800 font-medium">{error?.message || "Failed to load medical history"}</p>
                        </div>
                    </div>
                ) : medicalHistory ? (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="bg-blue-50 rounded-lg p-4">
                                ...
                                <div className="text-gray-900 font-medium">
                                    {patient ? patient.username : `Patient ID: ${medicalHistory.patientId}`}
                                </div>
                                <div className="text-sm text-gray-600">ID: {medicalHistory.patientId}</div>
                            </div>
                            ...
                            <div className="bg-purple-50 rounded-lg p-4">
                                ...
                                <div className="text-gray-900 font-medium">
                                    {doctor ? `Dr. ${doctor.username}` : `Doctor ID: ${medicalHistory.doctorId}`}
                                </div>
                                <div className="text-sm text-gray-600">ID: {medicalHistory.doctorId}</div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="w-full p-4 border border-gray-200 rounded-lg bg-red-50/50 min-h-[80px]">
                        ...
                        <div>
                            ...
                            <div className="w-full p-4 border border-gray-200 rounded-lg bg-yellow-50/50 min-h-[80px]">
                                <p className="text-gray-800 whitespace-pre-wrap">
                        ...
                        <div>
                            ...
                            <div className="w-full p-4 border border-gray-200 rounded-lg bg-green-50/50 min-h-[100px]">
                                <p className="text-gray-800 whitespace-pre-wrap">
                                    {medicalHistory.treatmentInstructions || "No treatment plan recorded"}
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="bg-gray-50 rounded-lg p-4">
                                ...
                                <div className="flex items-center">
                                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                                        ...
                                        {medicalHistory.active ? 'Active Treatment' : 'Inactive Treatment'}
                                    </span>
                                </div>
                            </div>
                        </div>
