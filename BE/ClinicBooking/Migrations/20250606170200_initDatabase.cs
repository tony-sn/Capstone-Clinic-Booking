        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_BookByUserID",
                        column: x => x.BookByUserID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LaboratoryTestReports", x => new { x.MedicalHistoryId, x.LaboratoryTestId });
                    table.ForeignKey(
                        name: "FK_LaboratoryTestReports_AspNetUsers_TechnicianId",
                        column: x => x.TechnicianId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_LaboratoryTestReports_LaboratoryTests_LaboratoryTestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaboratoryTestReportLaboratoryTestId = table.Column<int>(type: "int", nullable: true),
                    LaboratoryTestReportMedicalHistoryId = table.Column<int>(type: "int", nullable: true),
                    Id = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.LaboratoryTestReportMedicalHistoryId, x.LaboratoryTestReportLaboratoryTestId },
                        principalTable: "LaboratoryTestReports",
                        principalColumns: new[] { "MedicalHistoryId", "LaboratoryTestId" });
                });

            migrationBuilder.CreateTable(
                name: "MedicineInventoryEntries",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineInventoryEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicineInventoryEntries_Medicines_MedicineID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BookByUserID",
                table: "Appointments",
                column: "BookByUserID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_LaboratoryTestReportMedicalHistoryId_LaboratoryTestReportLaboratoryTestId",
                table: "Images",
                columns: new[] { "LaboratoryTestReportMedicalHistoryId", "LaboratoryTestReportLaboratoryTestId" });

            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryTestReports_LaboratoryTestId",
                table: "LaboratoryTestReports",
                column: "LaboratoryTestId");

            migrationBuilder.CreateIndex(
                name: "IX_LaboratoryTestReports_TechnicianId",
                table: "LaboratoryTestReports",
                column: "TechnicianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineInventoryEntries_MedicineID",
                table: "MedicineInventoryEntries",
                column: "MedicineID");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineInventoryEntries_PrescriptionID",
                table: "MedicineInventoryEntries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_MedicalHistoryId",
                table: "Transactions",
                column: "MedicalHistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_RevenueReportID",
                table: "Transactions",
